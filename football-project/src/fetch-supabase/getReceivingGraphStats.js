...
export async function getReceivingGraphStats(){
    ...
    .select("player_id, receiving_yards")
    ...
    .from("player_stats_offense")
    .select("player_id, receiving_touchdowns")
  ...
  .from('player_stats_offense')
  .select('player_id, receiving_yards, receptions, games_played, players(position)')
